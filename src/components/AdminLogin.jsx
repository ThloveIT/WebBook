...
const AdminLogin = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            setMessage("Please provide a valid user and password");
            console.log("Error", error)
        }
    }
    return (
        <div className='h-screenS border flex justify-center items-center'>
            <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    py-2 px-6 rounded focus:outline-none'>Login</button>
                    </div>
                </form>
