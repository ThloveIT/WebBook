...
const Register = () => {
    ...
    const {registerUser, signInWithGoole} = useAuth()
    const {
        register,
        handleSubmit,
        watch,
        ...
        <div className='h-[calc(100vh-120px)] border flex justify-center items-center'>
            <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    py-2 px-6 rounded focus:outline-none'>Register</button>
                    </div>
                </form>
                ...
                bg-secondary hover:bg-blue-700 text-white font-bold py-2 px-3 rounded
                focus:outline-none'>
